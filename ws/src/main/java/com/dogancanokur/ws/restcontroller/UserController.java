...
public class UserController {
	...
	if ((userInput.getUsername() == null || "".equals(userInput.getUsername()))
		|| (userInput.getDisplayName() == null || "".equals(userInput.getDisplayName()))
		|| (userInput.getPassword() == null || "".equals(userInput.getPassword()))) {
	    ...
	    ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST.value(), "Username cannot be empty.",
		    "/api/1.0/users", validationErrors);
